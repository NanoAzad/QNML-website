  ...
  return (
    <div className="min-h-screen bg-gray-100 text-gray-900 p-6 space-y-12">
      ...
      <section className="space-y-4">
        ...
        <p>
          View our publications on <a className="text-blue-600 underline" href="https://scholar.google.co.in/citations?user=S0PEM8sAAAAJ&hl=en">Google Scholar</a>.
        </p>
      </section>
      ...
      <section className="space-y-4">
        ...
        <p>
          We welcome highly motivated researchers and students to join our team. Reach out to us at <strong>aslam@phy.iitb.ac.in</strong> with your CV and a brief statement of interest.
        </p>
      </section>
      ...
      <section className="space-y-4">
        ...
        <p>Email: <a className="text-blue-600 underline" href="mailto:aslam@phy.iitb.ac.in">aslam@phy.iitb.ac.in</a></p>
        <p>Facebook: <a className="text-blue-600 underline" href="https://www.facebook.com/nanomaterialslab/">@nanomaterialslab</a></p>
      </section>
